  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (recaptchaToken) {
      try {
        ...
        const response = await axios.post("https://dcback.vercel.app/api/users/verify-google-recaptcha-token", {
        ...
        if (result.success) {
          try {
            ...
            const response = await axios.post("https://dcback.vercel.app/api/users/apply", formData, {
    ...
    <div className="careers-container">
      ...
      <div className="careers-body">
        <p className="careers-body-text">
          Making and delivering a pizza in about 30 minutes is a big challenge. In order to help the people who work at
          Domino’s to develop their talent and reach their potential, we offer:
        </p>
